...
export const getUsers = async () => {
  const response = await fetch(`${VERCEL_URL}/api/auth`);
  const json = response.json();
  return json;
};

export const getUser = async (userId) => {
  const response = await fetch(`${VERCEL_URL}/api/auth/${userId}`);
  const json = response.json();
...
export const getEmployeeData = async (email) => {
  const response = await fetch(`${VERCEL_URL}/api/auth/empData/${email}`);
  const json = response.json();
