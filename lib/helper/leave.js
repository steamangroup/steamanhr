...
export const getLeaves = async () => {
  const response = await fetch(`${VERCEL_URL}/api/leaves`);
...
export const getLeave = async (id) => {
  const response = await fetch(`${VERCEL_URL}/api/leaves/${id}`);
  const json = response.json();
...
export async function addLeave(formData) {
  try {
    ...
    const response = await fetch(`${VERCEL_URL}/api/leaves`, Options);
    const json = response.json;
    return json;
  } catch (error) {
    return error;
...
export async function updateLeave(id, formData) {
  try {
    ...
    const response = await fetch(`${VERCEL_URL}/api/leaves/${id}`, Options);
    const json = response.json;
    return json;
  } catch (error) {
