...
export const getEmployeeLeaves = async (id) => {
  const response = await fetch(`${NETLIFY_URL}/api/leaves/employee/${id}`);
  const json = response.json();
...
export const getPendingLeaves = async (id) => {
  const response = await fetch(`${NETLIFY_URL}/api/leaves/status/pending${id}`);
  const json = response.json();
...
export const getApprovedLeaves = async (id) => {
  const response = await fetch(
    `${NETLIFY_URL}/api/leaves/status/approved/${id}`
  );
  const json = response.json();
...
export const getRejectedLeaves = async (id) => {
  const response = await fetch(
    `${NETLIFY_URL}/api/leaves/status/rejected/${id}`
  );
  const json = response.json();
...
export const getLeavePeriod = async () => {
  const response = await fetch(`${NETLIFY_URL}/api/leaves/duration`);
  const json = response.json();
